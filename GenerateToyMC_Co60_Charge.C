void GenerateToyMC_Co60_Charge()
{
...
// #### Co60 ####################################################################
  ...
  TFile *fCo60_ss = new TFile("/nfs/slac/g/exo/maweber/EXO200Analysis/Fitting/scripts/Co60_ToyMC_Charge_ss.root","RECREATE");
  tCo60_ss->Write();
  fCo60_ss->Close();
  
  TFile *fCo60_ms = new TFile("/nfs/slac/g/exo/maweber/EXO200Analysis/Fitting/scripts/Co60_ToyMC_Charge_ms.root","RECREATE");
  tCo60_ms->Write();
  fCo60_ms->Close();
