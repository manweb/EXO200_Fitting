void GenerateToyMC_Cs137_Charge()
{
...
// #### Cs137 ####################################################################
  ...
  TFile *fCs137_ss = new TFile("/nfs/slac/g/exo/maweber/EXO200Analysis/Fitting/scripts/Cs137_ToyMC_Charge_ss.root","RECREATE");
  tCs137_ss->Write();
  fCs137_ss->Close();
  
  TFile *fCs137_ms = new TFile("/nfs/slac/g/exo/maweber/EXO200Analysis/Fitting/scripts/Cs137_ToyMC_Charge_ms.root","RECREATE");
  tCs137_ms->Write();
  fCs137_ms->Close();
